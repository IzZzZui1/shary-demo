...
const catalog = [
  ...
  {
    "code": "Д-02",
    "name": "День рождения · прозрачный шар «Есиничке уже 9!»",
    "photo": "IMG_2279.jpg",
    "category": "день рождения",
    "icon": "🎂",
    "top": false,
  ...
  {
    "code": "П-02",
    "name": "Праздник · сердце «Мир начинается с тебя, мам»",
    "photo": "IMG_0499.jpg",
    "category": "прочее",
    "icon": "✨",
    "top": false,
  ...
  {
    "code": "П-14",
    "name": "Встреча · сердце «С приездом домой мы тебя так очень ждали!»",
    "photo": "IMG_3602.jpg",
    "category": "прочее",
    "icon": "✨",
    "top": false,
